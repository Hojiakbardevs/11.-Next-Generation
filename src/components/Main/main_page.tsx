...
export const MainPage = () => {
  return (
    <div>
      <div className="flex gap-20 justify-center items-center p-4">
        <p className="text-center text-sm bg-gray-400 px-4 py-2 flex items-center justify-center rounded-lg">
          By continuing to use this site you consent with our{" "}
          <span>cookie policy.</span>
        </p>
        <div className="flex justify-center items-center bg-gray-400 size-10">
          <svg
